...
var or__4131__auto__ = cljs.core.last(cljs.core.sort.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__6780_SHARP_){
return p1__6780_SHARP_.length();
}),cljs.core.keys(m))));
...
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6785,(1),null);
var len = k.length();
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__6788_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__6788_SHARP_,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(["PConstants/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(quil.util.prepare_quil_name(p1__6788_SHARP_))].join(''))],null));
}),constants));
});
quil.util.prepare_quil_cljs_constants = (function quil$util$prepare_quil_cljs_constants(constants){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__6789_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__6789_SHARP_,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic((new cljs.core.List(null,cljs.core.cst$sym$cljs$core_SLASH_aget,null,(1),null)),(new cljs.core.List(null,cljs.core.cst$sym$js_SLASH_p5$prototype,null,(1),null)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(new cljs.core.List(null,quil.util.prepare_quil_name(p1__6789_SHARP_),null,(1),null))], 0))))],null));
}),constants));
});
...
var ret__4776__auto___6795 = (function (){
quil.util.generate_quil_constants = (function quil$util$generate_quil_constants(var_args){
var args__4736__auto__ = [];
var len__4730__auto___6796 = arguments.length;
var i__4731__auto___6797 = (0);
while(true){
if((i__4731__auto___6797 < len__4730__auto___6796)){
args__4736__auto__.push((arguments[i__4731__auto___6797]));

var G__6798 = (i__4731__auto___6797 + (1));
i__4731__auto___6797 = G__6798;
continue;
} else {
}
break;
...
return cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2((new cljs.core.List(null,cljs.core.cst$sym$do,null,(1),null)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__6790_SHARP_){
return quil.util.make_quil_constant_map(target,cljs.core.first(p1__6790_SHARP_),cljs.core.second(p1__6790_SHARP_));
...
/** @this {Function} */
quil.util.generate_quil_constants.cljs$lang$applyTo = (function (seq6791){
var G__6792 = cljs.core.first(seq6791);
var seq6791__$1 = cljs.core.next(seq6791);
var G__6793 = cljs.core.first(seq6791__$1);
var seq6791__$2 = cljs.core.next(seq6791__$1);
var G__6794 = cljs.core.first(seq6791__$2);
var seq6791__$3 = cljs.core.next(seq6791__$2);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__6792,G__6793,G__6794,seq6791__$3);
});
