...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([initial_state,p1__7289_SHARP_], 0));
});})(initial_state))
);
});
/**
...
var nav_2d_7290 = cljs.core.cst$kw$navigation_DASH_2d.cljs$core$IFn$_invoke$arity$1(state);
var zoom_7291 = cljs.core.cst$kw$zoom.cljs$core$IFn$_invoke$arity$1(nav_2d_7290);
var pos_7292 = cljs.core.cst$kw$position.cljs$core$IFn$_invoke$arity$1(nav_2d_7290);
quil.core.scale.cljs$core$IFn$_invoke$arity$1(zoom_7291);

var tr__1734__auto___7293 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width() / (2)) / zoom_7291) - cljs.core.first(pos_7292)),(((quil.core.height() / (2)) / zoom_7291) - cljs.core.second(pos_7292))], null);
quil.core.push_matrix();

try{quil.core.translate.cljs$core$IFn$_invoke$arity$1(tr__1734__auto___7293);
...
var G__7294 = quil.middlewares.navigation_2d.mouse_dragged(state,event);
var G__7295 = event;
return (user_mouse_dragged.cljs$core$IFn$_invoke$arity$2 ? user_mouse_dragged.cljs$core$IFn$_invoke$arity$2(G__7294,G__7295) : user_mouse_dragged.call(null,G__7294,G__7295));
...
return (function (state,event){
var G__7296 = quil.middlewares.navigation_2d.mouse_wheel(state,event);
var G__7297 = event;
return (user_mouse_wheel.cljs$core$IFn$_invoke$arity$2 ? user_mouse_wheel.cljs$core$IFn$_invoke$arity$2(G__7296,G__7297) : user_mouse_wheel.call(null,G__7296,G__7297));
});})(user_settings,user_draw,user_mouse_dragged,user_mouse_wheel,setup))
], 0));
});
