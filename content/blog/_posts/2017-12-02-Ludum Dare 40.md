...
- Forced the camera to sort the things it saw by Z coordinate: taxi made it apparent that the spriters were z-fighting when its darker transulcent street sprite hid it more effectively than the very light floor sprite.
